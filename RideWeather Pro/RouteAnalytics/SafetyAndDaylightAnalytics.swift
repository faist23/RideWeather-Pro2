            ...
            VStack(spacing: 12) {
                HStack {
                    Image(systemName: "shield.fill")
                        ...
                        .foregroundStyle(safetyEngine.combinedSafetyScore.level.color)
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text(safetyEngine.combinedSafetyScore.level.label)
                            .font(.subheadline)
                            .foregroundStyle(safetyEngine.combinedSafetyScore.level.color)
                    }
                    ...
                    SafetyScoreRing(score: safetyEngine.combinedSafetyScore.score)
                }
                
                // Quick insights
                HStack(spacing: 16) {
                    SafetyInsightChip(
                        icon: safetyEngine.daylightAnalysis.visibilityRating.color == .red ? "moon.fill" : "sun.max.fill",
                        label: "Visibility",
                        value: safetyEngine.daylightAnalysis.visibilityRating.label,
                        color: safetyEngine.daylightAnalysis.visibilityRating.color
                    )
                ...
                if let topRecommendation = safetyEngine.safetyRecommendations.first {
                    HStack(spacing: 8) {
                        Image(systemName: topRecommendation.icon)
                            .foregroundStyle(topRecommendation.priority.color)
                    ...
                    .padding(.vertical, 6)
                    .background(topRecommendation.priority.color.opacity(0.1), in: Capsule())
                }
            }
            .padding(16)
